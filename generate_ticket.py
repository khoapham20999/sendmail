...
# define constant
DEFAULT_PATH = './images/'
FULL_PATH_TICKET_FILE_G = DEFAULT_PATH + 'e_ticket.png'   # template of ticket
FULL_PATH_TICKET_FILE_S = DEFAULT_PATH + 'e_ticket-S.png'
...
def make_qr_code(QRCode_image_name, sFullCode) : # QRCode_image_name w/o extention
    ...
    sQRCodeFile = DEFAULT_PATH + QRCode_image_name + '.png'
...
def generate_ticket(sShortCode, sFullCode, sFullName, sObject) :
    ...
    make_qr_code("QRCode", sFullCode) # generate <sShortCode>.png in DEFAULT_PATH

    sTempFileName = 'temp.png'
    sQRCodeFile = DEFAULT_PATH + 'QRCode' + '.png'
    if sObject == 'G':
        add_image(FULL_PATH_TICKET_FILE_G, sQRCodeFile, sTempFileName) # add QRCode image to ticket image -> final image temp.png in DEFAULT_PATH
    else:
